...
3. **Які магазини отримали найменше товарів і чи можна збільшити їх постачання, збільшивши пропускну здатність певних маршрутів?**
   - Магазини 3, 12, 13, 14 взагалі не отримали товарів (потік 0). Щоб вони отримали товари, необхідно суттєво збільшити пропускну здатність маршрутів: **Термінал 1 -> Склад 1** та **Термінал 2 -> Склад 4**.
